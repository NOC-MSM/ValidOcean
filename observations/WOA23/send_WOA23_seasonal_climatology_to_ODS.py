...
# --- Configure Logging --- #
logging.basicConfig(
    filename="send_WOA23_seasonal_climatology_to_ODS.log",
    encoding="utf-8",
    filemode="a",
...
prefix = "WOA23/WOA23_1971_2000_seasonal_climatology"
# Define rechunking:
rechunk = {'lat': 720, 'lon': 1440, 'depth':10}
# Define attributes to be added to dataset:
attrs = {"description":"World Ocean Atlas 2023 1971-2000 Seasonal Climatological mean temperature & salinity for the global ocean from objectively analysed in situ data.","date_downloaded":"02/01/2025","date_uploaded_to_ods":"06/04/2025","temporal_range":"1971-01-01 to 2000-12-31","geographic_extent":"[-180, 180, -90, -90]","doi":" https://doi.org/10.25921/va26-hv25"}

# -- Send WOA23 to ODS -- #
logging.info("In Progress: Sending WOA23 1971-2000 seasonal climate normal to Ocean Data Store...")
send(file=ds_seasonal71,
     bucket=bucket,
...
logging.info("Completed: Sent WOA23 1971-2000 seasonal climate normal to Ocean Data Store.")
...
# -- Define metadata for transfer to ODS -- #
# Define object prefix:
prefix = "WOA23/WOA23_1981_2010_seasonal_climatology"
# Define rechunking:
rechunk = {'lat': 720, 'lon': 1440, 'depth':10}
# Define attributes to be added to dataset:
attrs = {"description":"World Ocean Atlas 2023 1981-2010 Seasonal Climatological mean temperature & salinity for the global ocean from objectively analysed in situ data.","date_downloaded":"02/01/2025","date_uploaded_to_ods":"06/04/2025","temporal_range":"1981-01-01 to 2010-12-31","geographic_extent":"[-180, 180, -90, -90]","doi":" https://doi.org/10.25921/va26-hv25"}

# -- Send WOA23 to ODS -- #
logging.info("In Progress: Sending WOA23 1981-2010 seasonal climate normal to Ocean Data Store...")
send(file=ds_seasonal81,
     bucket=bucket,
     object_prefix=prefix,
     store_credentials_json=credentials_fpath,
     variables="consolidated",
...
logging.info("Completed: Sent WOA23 1981-2010 seasonal climate normal to Ocean Data Store.")
...
# -- Define metadata for transfer to ODS -- #
# Define object prefix:
prefix = "WOA23/WOA23_1991_2020_seasonal_climatology"
# Define rechunking:
rechunk = {'lat': 720, 'lon': 1440, 'depth':10}
# Define attributes to be added to dataset:
attrs = {"description":"World Ocean Atlas 2023 1991-2020 Seasonal Climatological mean temperature & salinity for the global ocean from objectively analysed in situ data.","date_downloaded":"02/01/2025","date_uploaded_to_ods":"06/04/2025","temporal_range":"1991-01-01 to 2020-12-31","geographic_extent":"[-180, 180, -90, -90]","doi":" https://doi.org/10.25921/va26-hv25"}

# -- Send WOA23 to ODS -- #
logging.info("In Progress: Sending WOA23 1991-2020 seasonal climate normal to Ocean Data Store...")
send(file=ds_seasonal91,
     bucket=bucket,
     object_prefix=prefix,
     store_credentials_json=credentials_fpath,
     variables="consolidated",
...
logging.info("Completed: Sent WOA23 1991-2020 seasonal climate normal to Ocean Data Store.")
