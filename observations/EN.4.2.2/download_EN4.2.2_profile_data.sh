...
echo "Downloading: files in EN.4.2.2.profiles.g10.download-list.txt..."

# Define the URL list:
urls=$(cat /dssgfs01/scratch/otooth/npd_data/observations/EN.4.2.2/src/EN.4.2.2.profiles.g10.download-list.txt)
...
# Update users via stdout:
echo "...Completed: EN.4.2.2 profiles dataset downloaded"
