"""
send_OISSTv2_monthly_to_ODS.py

Description: Python script to send the OISSTv2 monthly sst
...
# --- Configure Logging --- #
logging.basicConfig(
    filename="send_OISSTv2_sst_monthly_to_ODS.log",
    encoding="utf-8",
    filemode="a",
...
# -- Import OISSTv2 Sea Surface Temperature from NOAA -- #
# Define path to OISSTv2 obs.
ini_fpath = "http://psl.noaa.gov/thredds/dodsC/Datasets/noaa.oisst.v2.highres/sst.mon.mean.nc"
...
prefix = "OISSTv2/OISSTv2_sst_global_monthly"
...
logging.info("Completed: Sent OISSTv2 SST Observations to Ocean Data Store.")
