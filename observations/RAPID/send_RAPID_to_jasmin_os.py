"""
send_RAPID_to_jasmin_os.py

Description: Python script to send the RAPID-MOCHA
overturning  and transports to the JASMIN Object Store.
...
# -- Send RAPID Observations to JASMIN Object Store -- #
print('In Progress: Sending RAPID Observations to JASMIN Object Store...')

# Define path to RAPID obs.
ini_fpath = '/dssgfs01/scratch/otooth/npd_data/observations/RAPID/data/*.nc'
...
for file in files:
    ...
    dest = f"{bucket}/RAPID/{filename.replace('.nc', '')}"
...
print('Completed: Sent RAPID Observations to JASMIN Object Store.')
