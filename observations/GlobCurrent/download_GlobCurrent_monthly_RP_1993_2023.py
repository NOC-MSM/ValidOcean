...
out_fdir = "/dssgfs01/scratch/otooth/npd_data/observations/GlobCurrent/data/"

# Download the GlobCurrent analysis dataset:
for year in range(1995, 2024):
    copernicusmarine.subset(
      dataset_id="cmems_obs-mob_glo_phy-cur_my_0.25deg_P1M-m",
      ...
      file_format="zarr",
      output_filename=f"globcurrent_my_0.25deg_P1M-m_{year}.zarr",
    )
