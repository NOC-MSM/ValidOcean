...
print('In Progress: Post-Processing NSIDC Sea Ice Index Arctic Observations...')

# -- Load NSIDC Ancillary Data -- #
# Define filepath to ancillary data:
anc_fpath = "/dssgfs01/scratch/otooth/npd_data/observations/NSIDC/data/ancillary/NSIDC0771_LatLon_PS_N25km_v1.0.nc"
...
area_fpath = "/dssgfs01/scratch/otooth/npd_data/observations/NSIDC/data/ancillary/NSIDC0771_CellArea_PS_N25km_v1.0.nc"
# Open NSIDC grid cell area:
ds_area = xr.open_dataset(area_fpath)

# -- Load NSIDC Monthly Data -- #
# Define directory path:
dir_path = "/dssgfs01/scratch/otooth/npd_data/observations/NSIDC/data/arctic/"
...
out_fpath = "/dssgfs01/scratch/otooth/npd_data/observations/NSIDC/data/NSIDC_Sea_Ice_Index_v3_Arctic_combined_1978_2025.nc"
# Save dataset to netCDF file:
ds_si.to_netcdf(out_fpath, unlimited_dims='time')

print(f'Completed: Saved NSIDC Sea Ice Index Arctic Observations to netCDF file: {out_fpath}.')
